...
{
    /// <inheritdoc />
    public partial class AddSubscirbersAreasGoverneratesAndRestrictfksdelete : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Governerates_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Governerates_AspNetUsers_LastUpdatedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Areas_Governerates_GovernerateId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Subscribers_Governerates_GovernerateId",
                        column: x => x.GovernerateId,
                        principalTable: "Governerates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Areas_Name_GovernerateId",
                table: "Areas",
                columns: new[] { "Name", "GovernerateId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Governerates_CreatedById",
                table: "Governerates",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_Governerates_LastUpdatedById",
                table: "Governerates",
                column: "LastUpdatedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subscribers_GovernerateId",
                table: "Subscribers",
                column: "GovernerateId");
